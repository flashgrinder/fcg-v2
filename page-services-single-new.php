                ...
                <div class="header-page__heading">
                    ...
                    <div class="header-page__action">
                        ...
                        <a href="#" class="button button--blue btn-modal">
                            <span class="button__span" data-hover-btn="Получить консультацию">Получить консультацию</span> 
                        </a>
    ...
    <section class="why-us block--padding bg--white">
        <div class="why-us__body container">
            ...
            <div class="why-us__content wysiwyg text text--normal text--dark-gray">
                ...
                <p>
                    В текущей экономической и политической ситуации российские предприниматели все чаще задумываются о сохранении и развитии своего бизнеса, ищут возможности для проведения транзитных и банковских операции за границей. За последнее время в Сербии помимо общего
                    экономического роста и улучшения бизнес-климата, благодаря многим преобразованиям и реформам, значительно развился и продолжает совершенствоваться банковский сектор. Именно в Сербии в банках одна из самых простых процедур открытия
                    счетов и требуются небольшое количество документов. Сербия — это отличный вариант для решения ваших бизнес-задач.
                </p>
                <ul>
                    <li>Дружественная страна для России</li>
                    <li>Возможность открытия счета в любой валюте</li>
                    <li>Стабильная и универсальная банковская система</li>
                    <li>Выход на европейский рынок и взаимодействие с компаниями в США</li>
                    <li>Низкие, по сравнению с Европой, налоги</li>
                    <li>Понятные и стабильные юридические решения для транзитных и банковских операций</li>
                    <li>Быстрое получение ВНЖ при открытии компании</li>
                </ul>
    ...
    <section class="text-block bg--white block--padding">
        <div class="text-block__body container">
            ...
            <div class="text-block__content wysiwyg">
                <ul>
                    <li>Знание особенностей иностранного рынка</li>
                    <li>Знания в области избежания двойного налогообложения</li>
                    <li>Экспертность в области персональных налогов для иностранных граждан</li>
                    <li>Комплексная сербско-русская языковая поддержка</li>
                    <li>На территории Сербии работает представитель компании, который на месте оперативно получает всю корреспонденцию и осуществляет взаимодействие с местными службами</li>
                    <li>Все коммуникации происходят по типу “одного окна”, вам не нужно искать ответственного</li>
                </ul>
            </div>
        </div>
    </section>
